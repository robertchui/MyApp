...
public class ForumCategoryListAdapter extends ArrayAdapter<ForumCategoryItem> {
	
	private Context context;
	private ArrayList<ForumCategoryItem> activityItems;
	
	public ForumCategoryListAdapter(Context ctx, int textViewResourceId, ArrayList<ForumCategoryItem> activityItems){
		super(ctx, R.layout.listitem_forum_category, textViewResourceId);
		this.context = ctx;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.listitem_forum_category, null);
        }
