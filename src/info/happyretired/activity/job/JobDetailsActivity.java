...
public class JobDetailsActivity extends FragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments = new ArrayList(inputArray.size());
	        ...
	        {
	        	JobDetailsFragment fg = new JobDetailsFragment();
				fg.setPageDetails(i, inputArray.size());
				//fg.changeData((String[])inputArray.get(i));
				fg.changeData((JobItem)inputArray.get(i));
	            fragments.add(fg);
	        }
        }
        activityItem = (JobItem)inputArray.get(currentPage);
	...
	class MyAdapter extends FragmentPagerAdapter{
		...
		public Fragment getItem(int position) {
			...
			//activityItem = ((JobDetailsFragment)fragments.get(position)).getActivityItem();
