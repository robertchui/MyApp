	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        OnPageChangeListener pageChangeListener = new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
            	activityItem = (ActivityItem)inputArray.get(position);
            	Intent myIntent = new Intent();
    	        myIntent.setAction(Intent.ACTION_SEND);
        ...
        activityItem = (ActivityItem)inputArray.get(currentPage);
        ...
        fragments = new ArrayList(inputArray.size());
	        ...
	        {
	        	EventDetailsFragment fg = new EventDetailsFragment();
				fg.setPageDetails(i, inputArray.size());
				//fg.changeData((String[])inputArray.get(i));
				fg.changeData((ActivityItem)inputArray.get(i));
	            fragments.add(fg);
	        }
        }
