...
public class VolunteerDetailsActivity extends FragmentActivity{

	VolunteerItem activityItem;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        activityItem = (VolunteerItem)inputArray.get(currentPage);
        ...
        fragments = new ArrayList(inputArray.size());
	        ...
	        {
	        	VolunteerDetailsFragment fg = new VolunteerDetailsFragment();
				fg.setPageDetails(i, inputArray.size());
				//fg.changeData((String[])inputArray.get(i));
				fg.changeData((VolunteerItem)inputArray.get(i));
	            fragments.add(fg);
	        }
        }
