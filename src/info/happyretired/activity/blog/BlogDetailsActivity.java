...
public class BlogDetailsActivity extends FragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        OnPageChangeListener pageChangeListener = new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
            	activityItem = (Blogger)inputArray.get(position);
            	Intent myIntent = new Intent();
    	        myIntent.setAction(Intent.ACTION_SEND);
    	        //myIntent.putExtra(Intent.EXTRA_SUBJECT, activityItem.getLast_post_title()+" | "+activityItem.getUser_name());
        ...
        activityItem = (Blogger)inputArray.get(currentPage);
        ...
        fragments = new ArrayList(inputArray.size());
	        ...
	        {
	        	BlogDetailsFragment fg = new BlogDetailsFragment();
				fg.setPageDetails(i, inputArray.size());
				//fg.changeData((String[])inputArray.get(i));
				fg.setActivityItem((Blogger)inputArray.get(i));
	            fragments.add(fg);
	        }
        }
        
        Tracker tracker = GoogleAnalytics.getInstance(this).getTracker("UA-48863792-2");
		tracker.set(Fields.SCREEN_NAME, "Blog Details Screen");
