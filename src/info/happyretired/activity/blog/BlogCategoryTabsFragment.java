...
public class BlogCategoryTabsFragment extends ListFragment implements SwipeRefreshLayout.OnRefreshListener   {
	...
	public BlogCategoryTabsFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(mlist.size()==0){
			...
			mlist = constant.getBlogCategoryList();
		}
	...
	public String readActivityFeed() {
        ...
        try {
          ...
          if (statusCode == 200) {
            ...
            Log.e(BlogCategoryTabsFragment.class.toString(), "Failed to download file");
          }
